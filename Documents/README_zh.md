...
推荐在运行 macOS 15 或更新版本的实体 Apple Silicon Mac 上使用已公证的 [vphone-launchpad 2.0.5](https://github.com/Lakr233/vphone-cli/releases/download/2.0.5/vphone-launchpad-2.0.5-notarized.zip)。运行发布版无需 Xcode、Python 或 Homebrew。
