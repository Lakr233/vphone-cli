<div align="right"><a href="../README.md">English</a> · <a href="README_zh.md">中文</a> · <strong>日本語</strong> · <a href="README_ko.md">한국어</a> · <a href="README_ru.md">Русский</a> · <a href="README_pt.md">Português</a></div>
...
AMFI の許可リストを使う場合、ビルドのたびに `make amfi_allow` を再実行してください。[ドキュメント一覧](README.md)から現在の手順と研究資料に進めます。詳しいガイドは現在英語です。
