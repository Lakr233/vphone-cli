...
struct VPhoneVMLaunchCommand: ParsableCommand {
    ...
    @Flag(name: .customLong("virtual-camera"), help: "Publish the VM display as a Host CMIO virtual camera") var virtualCamera = false
    ...
    func run() throws {
        ...
        if virtualCamera { args.append("--virtual-camera") }
