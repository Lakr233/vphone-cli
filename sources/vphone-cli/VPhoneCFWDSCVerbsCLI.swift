// VPhoneCFWDSCVerbsCLI.swift — `cfw` verbs for the dyld-shared-cache patchers.
//
...
enum VPhoneCFWDSCVerbs {
    /// Registered into `vphone-cli cfw` by `VPhoneCFWCommand`.
    static let all: [ParsableCommand.Type] = [
        VPhoneCFWPatchHVVMMDSCCommand.self,
        VPhoneCFWPatchIOMFBSwapEndCommand.self,
        VPhoneCFWPatchIOMFBForceKernCommand.self,
        VPhoneCFWPatchDSCMaxSlideCommand.self,
        VPhoneCFWPatchLSDEmbeddedRegCommand.self,
        VPhoneCFWPatchXPCLWCRCommand.self,
        VPhoneCFWPatchLockdownModeCommand.self,
        VPhoneCFWPatchCameraDSCCommand.self,
    ]
    ...
    static func parseCInteger(_ value: String) throws -> UInt32 {
        ...
        let (radix, digits): (Int, Substring) = switch cleaned.prefix(2).lowercased() {
...
struct VPhoneCFWPatchHVVMMDSCCommand: ParsableCommand {
...
struct VPhoneCFWPatchIOMFBSwapEndCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
    ...
    func run() throws {
        try DSCIOMFBSwapEndPatcher.patch(
            chunksDirectory: chunksDirectory,
...
struct VPhoneCFWPatchIOMFBForceKernCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
...
struct VPhoneCFWPatchDSCMaxSlideCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
...
struct VPhoneCFWPatchLSDEmbeddedRegCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
...
struct VPhoneCFWPatchXPCLWCRCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
...
struct VPhoneCFWPatchLockdownModeCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
...
struct VPhoneCFWPatchCameraDSCCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
