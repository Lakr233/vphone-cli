...
public enum VPhoneRestoreBridge {
    // MARK: recovery-probe
    ...
    public static func fetchSHSH(
        ...
        let contents = try VPhoneRestoreTicket.plistData(
            of: try Data(contentsOf: written),
            at: written
        )
    ...
    public static func restore(
        ...
        try VPhoneRestoreRunner.run(
            VPhoneRestoreOptions(
                ...
                // where they always have — no matter where the CLI is invoked.
