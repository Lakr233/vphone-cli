// CFWInjectDylib.swift — LC_LOAD_DYLIB / LC_LOAD_WEAK_DYLIB insertion.
//
...
public struct CFWDylibInjection: Sendable {
...
public enum CFWInjectDylib {
    ...
    /// ones shorter.
    static func injectFat(into data: inout Data, options: Options) throws -> [CFWDylibInjection] {
        ...
        var injections: [CFWDylibInjection] = []
    ...
    static func reattestSlice(
        ...
        let records = try CFWMachOCodeSignature.reattest(&slice, modifiedOffsets: offsets)
